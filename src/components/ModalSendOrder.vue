    ...
    <q-dialog persistent v-model="showModal">
        <q-card style="width: 500px;">
            ...
            <template v-if="isSuccess">
                <div class="text-h6 text-center q-mt-xl q-mb-lg">Заявка на отправку успешно создана!</div>
            </template>
            
            <q-card-actions align="right">
                <q-btn label="Отправить заказ" color="positive" no-caps class="btn" :disable="!(meta.valid && garant)" @click="sendForm" v-if="showForm"/>
...
<script setup>
    ...
    const props = defineProps(['isShowSendOrder'])
    ...
    const showModal = ref(props.isShowSendOrder)
